...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        /// <summary>
        /// Returns the Full file path for a txt file
        /// </summary>
        ...
        {
            //id,TN,EF,(id|id|id- ET), (id|id|id-Prizes), (Rounds - id^id^id|id^id^id|id^id^id)
            List<TournamentModel> output = new List<TournamentModel>();
            List<TeamModel> teams = teamFileName.FullFilePath().LoadFile().ConvertToTeamModels(peopleFileName);
            List<PrizeModel> prizes = prizeFilename.FullFilePath().LoadFile().ConvertToPrizeModels(prizeFilename);
        ...
        public static void SaveTotournamentsFile(this List<TournamentModel> models, string fileName)
        {
            ...
            foreach (TournamentModel tm in models)
            {
                lines.Add($@"{tm.Id},
                    ...
                    {ConvertPrizeListToString(tm.Prizes)},{tm.Rounds}");
            }
            File.WriteAllLines(fileName.FullFilePath(), lines);
        }
        ...
        private static string ConvertPrizeListToString(List<PrizeModel> prize)
        {
            ...
            foreach (PrizeModel pz in prize)
            {
                output += $"{pz.Id}|";
            }
